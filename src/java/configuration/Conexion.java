...
public class Conexion {
    ...
    public Conexion(){
        try{
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/ProyectoIN5BM?useTimeZone=true&serverTimezone=UTC&autoReconnect=true&useSSL=false", "root","root");
